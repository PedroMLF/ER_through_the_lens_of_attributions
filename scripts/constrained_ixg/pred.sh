...
#SBATCH -o outputs/constrained_ixg_norm/log_pred.out
...
EXPERIMENT_PATH="checkpoints/constrained_ixg_norm/train"
...
do
    ...
    # We keep only the model versions that converge CE loss while constraining explanation loss
    for VERSION in 0 1 4 7 16 23 25 26 28 29 36 38 41 45 49; do
