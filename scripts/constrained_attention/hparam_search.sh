...
#SBATCH -o outputs/constrained_attention/log_hparam.out
...
python ${PROJECT_HOME}/src/hparam_optuna.py \
    --save_dir "checkpoints/constrained_attention/hparam_search" \
    --search_space_path "scripts/constrained_attention/hparam_search_space.json" \
