...
#SBATCH -o outputs/joint_rollout/log_hparam.out
...
python ${PROJECT_HOME}/src/hparam_optuna.py \
    --save_dir "checkpoints/joint_rollout/hparam_search" \
    --search_space_path "scripts/joint_rollout/hparam_search_space.json" \
