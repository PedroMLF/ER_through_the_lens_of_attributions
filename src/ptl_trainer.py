### NOTE: Since I want to keep using PTL 1.7.7, I have manually added the inference_mode flag to Trainer,
### as described in the corresponding PR: https://github.com/Lightning-AI/pytorch-lightning/pull/15034/files
...
class Trainer(
    ...
    def _run_evaluate(self) -> _EVALUATE_OUTPUT:
        ...
        with self.profiler.profile(f"run_{self.state.stage}_evaluation"), _evaluation_context(self.accelerator, self._inference_mode):
